...
class V270ObservabilityTests(unittest.TestCase):
    ...
    def test_planning_statistics_are_scope_filtered(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            base = {
                "routing_mode": "adaptive", "lead_model": "gpt-5.6-sol", "lead_effort": "high",
    ...
    def test_report_collects_planning_and_shadow_without_refresh(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            planning_store.append(planning_store.default_path(registry), planning_store.from_plan({
                "routing_mode": "adaptive", "lead_model": "gpt-5.6-sol", "lead_effort": "high",
                "decisions": [{"execution_shape": "local_parallel_tools"}], "workers": [],
                "ready_worker_ids": [], "open_workers": 0, "effective_wave_limit": 3,
                "runtime_health": "healthy", "effective_runtime_health": "healthy",
                "runtime_health_action": "use_ready_wave", "health_probe_worker_id": None,
            }, "project-a"))
            decision_store.append(decision_store.default_path(), {
                "checkpoint_id": "a" * 32, "scope_id": "project-a", "task_family": "repo-scan",
                "provider": "jev_ask", "provider_model": "jev-test", "status": "available",
                "reason": None, "latency_ms": 10, "confidence": 0.9, "lease": "checkpoint",
                "answers": {"task_kind": "scan"},
            })
            with patch.dict(os.environ, {"CODEX_HOME": str(home)}),                  patch.object(report.store, "default_registry_path", return_value=registry),                  patch.object(report.route_advisor, "stats", return_value={"scope": "project-a", "outcomes": {}, "by_model": [], "pending_count": 0, "available_recommendations": []}),                  patch.object(report.token_usage, "statistics", return_value={"workers": [], "observed_subagents": 0, "known_usage": {"counts": {}}, "completeness": {}, "by_model": []}),                  patch.object(report.turn_usage, "statistics", return_value=[]):
            ...
            brief = report.markdown({"generated_at": "2026-09-22T00:00:00Z", "router_version": "2.7.0",
                                     "scope": {"scope_id": "project-a", "mode": "current"}, "data": data})
