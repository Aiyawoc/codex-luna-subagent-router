...
class SolRuntimeIdTests(unittest.TestCase):
    ...
    def test_route_validator_uses_explicit_sol_runtime_id(self) -> None:
        ...
        self.assertIn("gpt-6-sol", module.ADAPTIVE_MODELS)
        self.assertNotIn("gpt-5.6", module.ADAPTIVE_MODELS)
        self.assertEqual(module.PROFILE_BY_ROUTE[("gpt-6-sol", "high")], "sol_high")
        self.assertEqual(module.PROFILE_BY_ROUTE[("gpt-6-sol", "xhigh")], "sol_xhigh")
    ...
    def test_runtime_docs_do_not_route_sol_through_alias(self) -> None:
        ...
        self.assertIn("不得用旧 `gpt-5.6` alias 做自动 spawn", skill)
        self.assertIn("gpt-6-sol", policy)
