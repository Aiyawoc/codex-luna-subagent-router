...
class HistoryCalibrationTests(unittest.TestCase):
    def test_two_same_tier_passes_can_lower_effort(self) -> None:
        base = advisor._route("gpt-6-luna", "max")
        records = [
            {"model": "gpt-6-luna", "effort": "high", "outcome": "verified_pass", "identity_verified": True},
            {"model": "gpt-6-luna", "effort": "high", "outcome": "verified_pass", "identity_verified": True},
        ]
        ...
        self.assertEqual((result["model"], result["effort"]), ("gpt-6-luna", "high"))
