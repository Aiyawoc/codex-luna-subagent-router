...
当前稳定版：[**v2.6.6**](https://github.com/Aiyawoc/codex-luna-subagent-router/releases/tag/v2.6.6) · [更新记录](CHANGELOG.md) · [MIT License](LICENSE)

> **普通用户请下载 Release 中与系统和 CPU 匹配的完整包。** GitHub 自动生成的 `Source code.zip/.tar.gz` 不包含私有 Python 运行环境。v2.6.6 完整包内置 CPython 3.13.15，不依赖系统 Python、pip、uv 或 PATH。
...
```text
请安装或升级 Agent Router（Skill ID：`$codex-luna-subagent-router`）到当前稳定版 v2.6.6：
https://github.com/Aiyawoc/codex-luna-subagent-router/releases/tag/v2.6.6

先识别本机操作系统与 CPU 架构，下载匹配的 router-2.6.6-<platform> 完整包和校验文件。
...
从 [v2.6.6 Release](https://github.com/Aiyawoc/codex-luna-subagent-router/releases/tag/v2.6.6) 下载：
