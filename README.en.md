...
Current stable release: [**v2.6.5**](https://github.com/Aiyawoc/codex-luna-subagent-router/releases/tag/v2.6.5) · [Changelog](CHANGELOG.md) · [MIT License](LICENSE)
...
```text
Install or upgrade Agent Router (Skill ID: `$codex-luna-subagent-router`) to stable v2.6.5:
...
router-2.6.5-<platform> complete package and checksum files.
...
From the [v2.6.5 Release](https://github.com/Aiyawoc/codex-luna-subagent-router/releases/tag/v2.6.5), download:
